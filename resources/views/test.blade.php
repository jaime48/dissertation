...
<header class="header fixed fixed-desktop dark clearfix transparent-header-on object-visible">
            ...
            <div class="col-md-auto hidden-md-down pl-3">
                ...
                <div class="header-first clearfix">
                    ...
                    <div id="logo" class="logo">
                        <a href="index.html"><img id="logo_img" src="images/logo_vivid_red.png" alt="The Project"></a>
                    </div>
                        ...
                        <nav class="navbar navbar-toggleable-md navbar-light p-0">
                            ...
                            <div class="navbar-brand clearfix hidden-lg-up">
                                ...
                                <div id="logo-mobile" class="logo">
                                    <a href="index.html"><img id="logo-img-mobile" src="images/logo_vivid_red.png" alt="The Project"></a>
                                </div>
