...
<script src="{{asset('js/team_calendar/Plugins/jquery.calendar.js')}}" type="text/javascript"></script>
<script src="{{asset('js/team_calendar/sample.js')}}" type="text/javascript"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="infocontainer">
                <form action="updateTeamCalendarInfo" class="fform" id="fmEdit" method="post">
                    {{csrf_field()}}
                    <label>
            <span>                        *Subject:
            </span>
