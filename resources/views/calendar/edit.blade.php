...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>    
    ...
    <title>Calendar Details</title>    
      ...
      <link href="{{asset('css/calendar/dropdown.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('css/calendar/dp.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('css/calendar/colorselect.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('css/calendar/main.css')}}" rel="stylesheet" type="text/css" />
      <script src="{{asset('js/jquery.js')}}"></script>
      <script src="{{asset('js/calendar/Plugins/jquery.ifrmdailog.js')}}" type="text/javascript"></script>
      <script src="{{asset('js/calendar/Plugins/Common.js')}}" type="text/javascript"></script>
      <script src="{{asset('js/calendar/Plugins/jquery.form.js')}}" type="text/javascript"></script>
      <script src="{{asset('js/calendar/Plugins/jquery.validate.js')}}" type="text/javascript"></script>
      <script src="{{asset('js/calendar/Plugins/datepicker_lang_US.js')}}" type="text/javascript"></script>
      <script src="{{asset('js/calendar/Plugins/jquery.datepicker.js')}}" type="text/javascript"></script>
      <script src="{{asset('js/calendar/Plugins/jquery.dropdown.js')}}" type="text/javascript"></script>
      <script src="{{asset('js/calendar/Plugins/jquery.colorselect.js')}}" type="text/javascript"></script>
...
//            $("#Closebtn").click(function() { CloseModelWindow1(); });
  ...
  <body>    
    <div>      
      ...
      <div class="infocontainer">            
        <form action="editCalendarInfo" class="fform" id="fmEdit" method="post">
            {{csrf_field()}}
          <label>                    
            <span>                        *Subject:              
            </span>                    
...
<?php echo isset($event)?$event->Description:""; ?>
            ...
            <span>                        Remark:
                ...
                <button type="button" id="Savebtn" class="imgbtn" >
          <span class="Save"  title="Save the calendar">Save(<u>S</u>)
          </span>
                </button>
            </label>
