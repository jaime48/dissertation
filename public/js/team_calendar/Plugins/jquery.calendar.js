...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function BuildWT(ht, dayarrs, events, dMax) {
            //1:
            ht.push("<tr>", "<th width=\"60\" rowspan=\"3\" id=\"amendTh\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th width=\"60\" rowspan=\"3\" id=\"amendTh\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th width=\"60\" rowspan=\"3\" id=\"amendTh\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>");
        ...
        function quickd(type) {
            ...
            $.get(option.quickDeleteUrl, param, function(data) {
                if (data) {
                    if (data.IsSuccess) {
                        de = null;
            ...
            if(data[7]==7){
                $.ajax({
                    ...
                    if(msg.event_type==1){
                        ...
                        $('#stpartdate').prop('disabled', true);
                        $('#etpartdate').prop('disabled', true);
        ...
        function dayupdate(data, start, end) {
            if (option.quickUpdateUrl != "" && data[8] == 1 && option.readonly != true) {
                ...
                if (option.quickUpdateHandler && $.isFunction(option.quickUpdateHandler)) {
                    ...
                    $.get(option.quickUpdateUrl, param, function(data) {
                        if (data) {
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(
                    //i18n.xgcalendar.update_detail, ' <StrONG>&gt;&gt;</StrONG></SPAN></div></div></div><tr><td>' +
                    '<div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose1" class="bubble-closebutton"></div><div id="prong2" class="prong"><div class=bubble-sprite></div></div></div>');
                ...
                calbutton.click(function(e) {
                    ...
                    if (option.quickAddHandler && $.isFunction(option.quickAddHandler)) {
                        ...
                        $.get(option.quickAddUrl, param, function(data) {
                            if (data) {
                                if (data.IsSuccess == true) {
                                    option.isloading = false;
